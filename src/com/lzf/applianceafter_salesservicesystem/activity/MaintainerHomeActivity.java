...
@SuppressLint("NewApi")
public class MaintainerHomeActivity extends Activity implements
		PartFragment.OnFragmentInteractionListener,
		MaintenanceMaintainerFragment.OnFragmentInteractionListener,
		WorkFieldFragment.OnFragmentInteractionListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if ("18334706003".equals(SPUtil.get(this, "maintainer_phone", ""))
				|| "超级维修员".equals(SPUtil.get(this, "maintainer_name", ""))) {
	...
	private void hideAllFragment(FragmentTransaction fragmentTransaction) {
		...
		if (maintenanceMaintainerFragment != null)
			fragmentTransaction.hide(maintenanceMaintainerFragment);
		if (workFieldFragment != null)
			fragmentTransaction.hide(workFieldFragment);
	}
	...
	public void doClick(View view) {
		if (view.getId() == R.id.add_maintainer) {
			...
			case R.id.work_field:
				...
				if (workFieldFragment == null) {
					workFieldFragment = WorkFieldFragment.newInstance("工作栏",
							"工作栏");
			...
			case R.id.maintenance_request:
				...
				if (maintenanceMaintainerFragment == null) {
					maintenanceMaintainerFragment = MaintenanceMaintainerFragment
							.newInstance("维修申请", "维修申请");
					fTransaction.add(R.id.ly_content,
							maintenanceMaintainerFragment);
				} else {
	...
	public void onFragmentInteraction(Class activityClass,
		...
		if (activityClass != null) {
			if ("MainActivity".equals(activityClass.getSimpleName())) {
				...
				startActivity(new Intent(this, activityClass));
			} else if ("MaintainerDetailActivity".equals(activityClass
					.getSimpleName())) {
