...
public class AddPartActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appliance_model = (EditText) findViewById(R.id.appliance_model);
        appliance_part = (EditText) findViewById(R.id.appliance_part);
        appliance_price = (EditText) findViewById(R.id.appliance_price);
        appliance_arg = (EditText) findViewById(R.id.appliance_arg);
    }
