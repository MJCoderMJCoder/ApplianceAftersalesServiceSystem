 ...
 * must implement the
 * {@link MaintenanceUserFragment.OnFragmentInteractionListener} interface to
 * handle interaction events. Use the
 * {@link MaintenanceUserFragment#newInstance} factory method to create an
...
public class MaintenanceUserFragment extends Fragment {
	...
	public static MaintenanceUserFragment newInstance(String param1,
			String param2) {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.fragment_maintenance_user,
				container, false);
		context = getActivity();
		progressBar = (ProgressBar) view.findViewById(R.id.progressBar);
		view.findViewById(R.id.add_maintenance).setOnClickListener(
		...
		reusableAdapter = new ReusableAdapter<Maintenance>(maintenanceList,
				R.layout.item_maintenance_user) {
			@Override
			public void bindView(ViewHolder holder, final Maintenance obj) {
				...
				case 0:
										...
										public void run() {
											...
											try {
												...
												if (conn != null) {
													...
													if (exeNums == 1) {
														ps = conn
																.prepareStatement("SELECT * FROM maintenance where maintenance_user = "
																		+ SPUtil.get(
																				context,
																				"user_id",
																				0));
					...
					holder.setOnClickListener(R.id.modify,
							new View.OnClickListener() {
								@Override
								public void onClick(View v) {
									Intent intent = new Intent(context,
											ModifyMaintenanceActivity.class);
				...
				holder.setOnClickListener(R.id.detail,
						new View.OnClickListener() {
							...
							public void onClick(View v) {
								...
								// onButtonPressed(UserDetailActivity.class,
								// obj);
							}
						});
			}
